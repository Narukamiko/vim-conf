...
hi cppSTLfunction ctermbg=none cterm=bold,italic ctermfg=Yellow
hi cppSTLfunctional ctermbg=none cterm=bold,italic ctermfg=Yellow
hi cppSTLconstant ctermbg=none cterm=bold,italic ctermfg=Green
hi cppSTLnamespace ctermbg=none cterm=bold,italic ctermfg=Cyan
